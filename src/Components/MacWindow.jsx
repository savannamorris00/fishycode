...
export default function MacWindow() {
  ...
  return (
   <div className="relative min-h-screen bg-linear-to-b from-orange-300 via-rose-300 to-sky-200 overflow-hidden">
      {/* Wave Background */}
      <Wave
        paused={false}
        style={{
      ...
      <div className="relative z-1 min-h-screen flex items-center justify-center p-4">
        <div className="w-[700px] h-[460px] bg-white rounded-xl shadow-2xl border border-gray-300 overflow-hidden flex flex-col">
          {/* Top Bar */}
          <div className="h-10 bg-[#363636] flex items-center px-4 border-b border-gray-800">
